...
public class GundamFreedom extends AdvancedRobot {
    ...
    public void onHitRobot(HitRobotEvent event) {
        turnRadarRight(event.getBearing()+getHeading()-getRadarHeading());
